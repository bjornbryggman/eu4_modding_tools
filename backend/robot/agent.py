...
def setup_code_refactorer_agent():
    ...
    litellm.register_prompt_template(
        ...
        roles={
            ...
            "user": {"pre_message": "[CODE] ", "post_message": " [/CODE]"},
            "assistant": {"pre_message": "[REFACTOR] ", "post_message": "\n[/REFACTOR]"},
        },
...
def refactor_code(source_code: str):
    ...
    messages = [{"role": "system", "content": f"{source_code}"}, {"role": "user", "content": f"{source_code}"}]
...
def setup_code_auditor_agent():
    ...
    litellm.register_prompt_template(
        ...
        roles={
            ...
            "user": {"pre_message": "[CODE] ", "post_message": " [/CODE]"},
            "assistant": {"pre_message": "[REPORT] ", "post_message": "\n[/REPORT]"},
        },
...
def setup_code_documentarian_agent():
    ...
    litellm.register_prompt_template(
        ...
        roles={
            ...
            "user": {"pre_message": "[CODE] ", "post_message": " [/CODE]"},
            "assistant": {"pre_message": "[ENHANCEMENT] ", "post_message": "\n[/ENHANCEMENT]"},
        },
...
def document_and_provide_insights(source_code: str):
    ...
    messages = [{"role": "system", "content": "Analyze and document."}, {"role": "user", "content": f"{source_code}"}]
...
def setup_code_integrator_agent():
    ...
    litellm.register_prompt_template(
        ...
        roles={
            ...
            "final_output": {"pre_message": "[FINAL CODE] ", "post_message": "\n[/FINAL CODE]"},
        },
...
async def collect_feedback_and_integrate(initial_code, refactor_feedback, audit_feedback, documentation_feedback):
    ...
    final_code_version = litellm.completion(
        model="your-model-name-here", messages=[{"role": "integrator_input", "content": feedback_aggregation}]
    )
